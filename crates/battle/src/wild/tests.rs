...
/// The rejection arm is a deliberate ratchet, and it has already moved
/// once: before issue #293 the Seedot was blocked by Bide *and* Harden, but
/// Harden is `EFFECT_DEFENSE_UP`, now part of the widened
...
fn ensure_wild_startable_accepts_route_101_mons_and_rejects_a_bide_seedot() {
    ...
    assert_eq!(
        ...
        Ok(()),
        "MOVE_HARDEN is EFFECT_DEFENSE_UP, executable since issue #293"
    );
