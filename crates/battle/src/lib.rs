...
//! [`ability::guts_attack`] and [`ability::marvel_scale_defense`] read
...
//! `EFFECT_PARALYZE_HIT`), `EFFECT_RECOIL` for any move but Struggle (issue
//! #877 special-cases Struggle's own certain quarter-HP recoil rather than
//! adding a general recoil pipeline — Take Down and Submission stay
//! refused), OHKO, Counter, Bide, Leech Seed and the rest of the end-of-turn
