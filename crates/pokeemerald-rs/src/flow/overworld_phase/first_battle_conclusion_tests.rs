...
/// of a real outcome. Since #1191 the headless driver falls back to the next
/// usable move, so every slot -- not just slot 0 -- must be drained for the
/// turn to remain genuinely unplayable.
#[test]
