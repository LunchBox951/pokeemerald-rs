...
//! readers cover the title screen, the interface palettes, the tilesets,
//! and the map layouts so far, and later slices fill in the rest (see
//! `rom_import`'s own module docs).
//!
